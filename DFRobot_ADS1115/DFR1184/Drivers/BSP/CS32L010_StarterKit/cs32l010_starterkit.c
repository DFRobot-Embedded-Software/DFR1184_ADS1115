/**
  ******************************************************************************
  * @file    cs32l010_starterkit.c
	* @author  MCU Software Team
	* @Version V1.0.0
  * @Date    21-Oct-2019
  * @brief   This file provides set of firmware functions to manage:
  *          - LED, push-button, EEPROM and External SPI flash available on CS32L010-StarterKit 
  *            from ChipSea
  *
  @verbatim
 **/
...
/** @defgroup CS32L010_STARTERKIT CS32L010 STARTERKIT
  * @brief This file provides set of firmware functions to manage Leds and push-button
  *        available on CS32L010-Starter Kit.
  *        It provides also EEPROM, spi flashfunctions. 
  * @{
  */ 


/** @defgroup CS32L010_STARTERKIT_Private_Defines CS32L010 STARTERKIT Private Defines
  * @{
  */ 
  
/**
* @brief CS32L010 STARTERKIT BSP Driver version
*/
#define __CS32L010_STARTERKIT_BSP_VERSION_MAIN   (0x01) /*!< [31:24] main version */
#define __CS32L010_STARTERKIT_BSP_VERSION_SUB1   (0x00) /*!< [23:16] sub1 version */
#define __CS32L010_STARTERKIT_BSP_VERSION_SUB2   (0x04) /*!< [15:8]  sub2 version */
#define __CS32L010_STARTERKIT_BSP_VERSION_RC     (0x00) /*!< [7:0]  release candidate */ 
#define __CS32L010_STARTERKIT_BSP_VERSION       ((__CS32L010_STARTERKIT_BSP_VERSION_MAIN << 24)	 \
																									|(__CS32L010_STARTERKIT_BSP_VERSION_SUB1 << 16)\
																									|(__CS32L010_STARTERKIT_BSP_VERSION_SUB2 << 8 )\
																									|(__CS32L010_STARTERKIT_BSP_VERSION_RC))
...
/** @defgroup CS32L010_STARTERKIT_Private_Variables CS32L010 STARTERKIT Private Variables
  * @{
  */ 
...
/** @defgroup CS32L010_STARTERKIT_Private_Functions CS32L010 STARTERKIT Private Functions
  * @{
  */ 
#ifdef RESERVED_HAL_SPI_MODULE_ENABLED
...
/** @defgroup CS32L010_STARTERKIT_Exported_Functions CS32L010 STARTERKIT Exported Functions
  * @{
  */ 

/**
  * @brief  This method returns the CS32L010 STARTERKIT BSP Driver revision
  * @retval version : 0xXYZR (8bits for each decimal, R for RC)
  */
uint32_t BSP_GetVersion(void)
{
  return __CS32L010_STARTERKIT_BSP_VERSION;
}

/** @defgroup CS32L010_STARTERKIT_LED_Functions CS32L010 STARTERKIT LED Functions
  * @{
  */ 
...
/** @defgroup CS32L010_STARTERKIT_BUTTON_Functions CS32L010 STARTERKIT BUTTON Functions
  * @{
  */ 
...
/**
  * @}
  */ /* End of group CS32L010_STARTERKIT_Exported_Functions */

/** @addtogroup CS32L010_STARTERKIT_Private_Functions
  * @{
  */ 
...
/**
  * @}
  */ /* End of group CS32L010_STARTERKIT */  
